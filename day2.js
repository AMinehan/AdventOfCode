...
function partTwo(arr){
  ...
  for (var i = 0; i < arr.length; i++){
    ...
    for (var j = 0; j < arr[i].length; j ++){
      low = arr[i][j];
      for (var x = arr[i].length - 1; x > j; x--){
        high = arr[i][x]
        if (high % low === 0){
          total += high / low;
          break;
